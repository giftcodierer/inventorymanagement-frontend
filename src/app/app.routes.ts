...
import { BorrowedDevicesListComponent } from './borrowed-devices/borrowed-devices-list.component';
...
export const routes: Routes = [
  ...
  { path: 'detail/:id', component: InventoryManagementDetailComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN'] } },
