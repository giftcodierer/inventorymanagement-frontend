...
import { DepartmentListComponent } from './department-management/department-management-list/department-management-list.component';
...
export const routes: Routes = [
  ...
  { path: 'category/detail', component: CategoryManagementDetailComponent, canActivate: [AuthGuard] },
